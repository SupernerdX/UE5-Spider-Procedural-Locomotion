...
void FVoxelHeightSurfaceTypeChunk::GetAverageSurfaceType(
	float& OutAlpha,
	FVoxelSurfaceTypeBlend& OutSurfaceType) const
{
...
TVoxelRefCountPtr<FVoxelHeightSurfaceTypeChunk> FVoxelHeightSurfaceTypeChunk::Create(
...
void FVoxelHeightSurfaceTypeChunk::Serialize(
	FArchive& Ar,
	const int32 Version)
{
	VOXEL_FUNCTION_COUNTER();
